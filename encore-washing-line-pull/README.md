# Washing-line pull — encore edition

This is an explicit encore of the frozen washing-line study, not a new experiment. It republishes
the same solver, canonical reference, controls and result in a new edit. No input, threshold or
number has changed. The commands below independently reproduce the original registered evidence.
